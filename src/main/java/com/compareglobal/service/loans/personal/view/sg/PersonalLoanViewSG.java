 ...
 */
public class PersonalLoanViewSG implements TransformView {
    ...
    public enum ProductKeys {
        ...
        HandlingFeeWaiver("hasNoHandlingFee"),
    ...
    public JSONObject view(PersonalLoan personalLoan) {
        ...
        Filter feeWaiver = filterMap.get(ProductKeys.HandlingFeeWaiver.getProductKey());
        boolean noHandlingFee = feeWaiver != null
                                    && "true".equalsIgnoreCase(feeWaiver.getValue()) ? true : false;
        handlingFee.put(ViewKeys.HandlingFeeFlag.getViewKey(), noHandlingFee);
        ...
        List<Benefit> benefitListRaw = ListHelper.setToList(personalLoan.getBenefitsList());
        Ordering<Benefit> byKey= Ordering.natural().onResultOf(
                new Function<Benefit, String>() {
                    public String apply(Benefit benefit) {
                        return benefit.getTypeValue();
                    }
                });
        List<Benefit> sortedBenefits = byKey.sortedCopy(benefitListRaw);
