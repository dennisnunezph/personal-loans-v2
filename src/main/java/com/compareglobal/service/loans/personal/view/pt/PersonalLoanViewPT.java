 ...
 */
public class PersonalLoanViewPT implements TransformView {
    ...
    public enum ProductKeys {
        ...
        TotalPaymentHover("totalPaymentHover");
    ...
    public JSONObject view(PersonalLoan personalLoan) {
        ...
        GeneralInfo gInfo = ListHelper.findItemByTypeT(personalLoan.getGeneralInfo(),
                ProductKeys.TypeValue.getProductKey(),
                ProductKeys.TotalPaymentHover.getProductKey());
        if(gInfo != null) {
            displayView.put(ProductKeys.TotalPaymentHover.getProductKey(), gInfo.getDescription());
        }
